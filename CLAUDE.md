...
iPhone / browser
  ...
  ├─ OpenCV.js: edge detection, perspective correction, deskew
...
8. 一度目のperspective warpを3.5%広い範囲で実施
9. 補正画像から物理カード外周を再検出
10. 二度目のperspective warpで最終水平化
11. 1400 x 1960 pxの白背景へ配置し、JPEG quality 0.98で保持
...
- ワンピース: 外周は取れても約1°の傾きが残るケース。二段目の外周再検出で水平化する
- ガンダムアーセナルベース: 厳格判定落ち後の固定クロップで木目の机が残るケース。再補正候補またはガイド内再探索で救う
